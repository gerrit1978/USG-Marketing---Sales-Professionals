          ...
          <<?php print $tag; ?> id="main-content">
            ...
            <?php print render($title_suffix); // Prints page level contextual links ?>
	          ...
	          <?php print render($page['content_aside']); ?>
					...
					<?php print render($page['bottom_col1']); ?>
					
					<?php print render($page['bottom_col2']); ?>
					
					<?php print render($page['bottom_col3']); ?>
					</div>
        </div></div>
      ...
      <div id="tertiary-content-wrapper">
        <div class="container clearfix">
					<div class="tertiary-left">
					 <div class="clearfix">
						<ul class="tree-footer-left tree-footer">
							<?php print drupal_render($main_menu_tree_footer_left);?>
						</ul>
						<ul class="tree-footer-right tree-footer">
							<?php print drupal_render($main_menu_tree_footer_right);?>							
						</ul>	
					 </div>
						<?php print drupal_render($page['tertiary_bottom']); ?>
					</div>
					<div class="tertiary-right">
