...
hide($content['links']);
hide($content['field_job_regio']);
hide($content['field_uur_per_week']);
hide($content['field_job_arbeidsduur']);
hide($content['field_dienstverband']);
hide($content['field_functie']);
hide($content['field_branche']);
?>
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php endif; ?>
	...
	<div class="job-extra">
	  <?php print render($content['field_job_regio']); ?>
	  <?php print render($content['job_arbeid']); ?>
		<?php print render($content['job_functie_branche']); ?>
	</div>
